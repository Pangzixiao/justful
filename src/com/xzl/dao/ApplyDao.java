...
public interface ApplyDao {
    ...
    @Select("select a.* , p.p_name,p.p_cname,p.salary,p.p_address ,p.company_id from t_apply a left outer join  t_position p on a.position_id = p.position_id where a.user_id = #{user_id} and a.position_status=#{position_status}")
