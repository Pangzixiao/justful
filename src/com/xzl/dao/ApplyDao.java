...
public interface ApplyDao {
    ...
    List<Map<String,Object>> queryoutApplyByUserId(Map<String, Object> param);
    ...
    @Select("select * from t_apply where position_id=#{position_id} and user_id=#{user_id}")
    List<Map<String,Object>> isApplyExit(Map<String, Object> param);
}
