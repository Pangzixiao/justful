									...
									<table width="100%" border="0" cellspacing="0" cellpadding="4">
										...
										<tr>
											...
											<td><input name="user_id" type="text"
												class="input_text_200"  maxlength="80" value="${id}" /><br />
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input name="nation" type="text"
												class="input_text_200"  maxlength="80" value="" /></td>
										</tr>
										...
										<tr>
											...
											<td  >
												<textarea name="u_describe" class="input_text_200_textarea" style="width:450px; height:150px; margin-bottom:6px;" >${info.c_describe}</textarea>
												<br />
