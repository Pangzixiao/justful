    ...
    <tr>
        ...
        <td valign="top">
            <div class="user_right_box">
                ...
                <form id="newpositionForm" method="post" action="/company/newPosition">
                    <table width="100%" border="0" cellpadding="4" cellspacing="0"
                           style="margin-top:8px;">
                        <tr>
                            <td><input type="hidden" class="input_text_200" name="company_id" value="${info.company_id}"/>
                            <td>
                        </tr>

                        <tr>
                            <td><input type="hidden" class="input_text_200" name="p_cname" value="${info.company_name}"/>
                            <td>
                        </tr>
                        <tr>

                            <td width="100" height="30" align="right">
                                <span style="color:#FF3300; font-weight:bold">*</span> 职位名称：
                            </td>
                            <td><input name="p_name" type="text" class="input_text_200" maxlength="30" style=" width:350px;"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td height="30" align="right">
                                <span style="color:#FF3300; font-weight:bold">*</span> 工资：
                            </td>
                            <td>
                                <input name="salary" type="text" class="input_text_200" maxlength="30" style=" width:350px;"/></td>
                        </tr>

                        <tr>
                            <td height="30" align="right">
                                <span style="color:#FF3300; font-weight:bold">*</span> 招聘人数：
                            </td>
                            <td><input name="need_count" type="text" class="input_text_200" maxlength="30" style=" width:350px;"/></td>
                        </tr>

                        <tr>
                            <td align="right" valign="top"><span style="color:#FF3300; font-weight:bold">*</span> 职位描述：
                            </td>
                            <td>
                                <div>
										<textarea name="p_descript" class="input_text_200_textarea" style="width:450px; height:150px;"></textarea>
                                    <br/>
                                </div>
                        ...
                        <tr>
                            <td align="right" valign="top"><span style="color:#FF3300; font-weight:bold">*</span> 工作要求：
                            </td>
                            <td>
                                <div>
                                    <textarea name="p_request" class="input_text_200_textarea" style="width:450px; height:150px;"></textarea><br/>
                                </div>
                        ...
                        <tr>
                            <td align="right" valign="top"><span style="color:#FF3300; font-weight:bold">*</span> 福利待遇：
                            </td>
                            <td>
                                <div>
										<textarea name="treatment" class="input_text_200_textarea" id="" style="width:450px; height:150px;"></textarea>
                                    <br/>
                                </div>
                                                ...
                                                <table width="100%" border="0" cellspacing="6"
                                                    ...
                                                    <tr>
                                                        <td width="30%" align="left">
                                                            <input name="" type="submit" value="确定发布" class="but100"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
