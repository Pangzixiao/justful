		...
		<tr>
			...
			<td valign="top">
				<div class="user_right_box">
					...
					<form  method="post" action="/company/newPosition">
						<table width="100%" border="0" cellpadding="4" cellspacing="0"
							...
							<tr>
								...
								<td><input name="salary" type="text" class="input_text_200"  maxlength="30" style=" width:350px;" /></td>
							</tr>
								...
								<td>
									<div>
										<textarea name="treatment" class="input_text_200_textarea"
												  id="" style="width:450px; height:150px;"></textarea>
										<br />
									</div>
