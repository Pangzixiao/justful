                    ...
                    <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top:10px;">
                        <tr>
                            <td width="90" height="30" align="right"><span
                                    style="color:#FF3300; font-weight:bold">*</span>公司id：
                            </td>
                            <td><input type="text" value="${info.company_id}" readonly="readonly" name="company_id"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>
                        <tr>
                            <td width="90" height="30" align="right"><span
                                    style="color:#FF3300; font-weight:bold">*</span>公司名称：
                            </td>
                            <td><input type="text" value="${info.company_name}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>
                        <tr>
                            <td height="30" align="right"><span style="color:#FF3300; font-weight:bold">*</span>企业性质：
                            </td>
                            <td><input type="text" value="${info.c_type}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" value="${info.c_scale}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" value="${info.c_phone}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>

                        <tr>
                            <td height="30" align="right">公司网址：</td>
                            <td><input type="text" value="${info.c_websize}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>
                        <tr>
                            <td height="30" align="right"><span style="color:#FF3300; font-weight:bold">*</span>通讯地址：
                            </td>
                            <td><input type="text" value="${info.c_address}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>

                        <tr>
                            <td height="30" align="right"><span style="color:#FF3300; font-weight:bold">*</span>审核结果：
                            </td>
                            <td><input type="text" value="${info.check_type}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>


                        <tr>
                            <td height="30" align="right"><span style="color:#FF3300; font-weight:bold">*</span>注册时间：
                            </td>
                            <td><input type="text" value="${info.regist_date}" readonly="readonly"
                                       class="input_text_200 input_text_200_selsect"/></td>
                        </tr>
                        <tr>
