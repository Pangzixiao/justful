			...
			<td valign="top">
				<div class="user_right_box">
					<div class="user_right_top_tit_bg">
						<h1> <a href="/company/queryApplyByCom"> 所有申请</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="/company/queryApplyByCom?apply_status=邀请面试"> 同意的申请</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="/company/queryApplyByCom?apply_status=抱歉"> 拒绝的申请</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="/company/queryApplyByCom?apply_status=已申请"> 待处理的申请</a></h1>
					</div>
					...
					<form id="form1" name="form1" method="post"
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td width="15%" align="center" class="us_list_title">申请状态</td>
							...
							<tr>
								...
								<td align="center" class="us_list"><a href="/company/updateApplay?apply_id=${m.apply_id}">抱歉</a>&nbsp;
								</td>
							...
							<tr>
								<td height="50" align="center">
									<div class="page link_bk">
										<a href="${pageContext.request.contextPath}/company/queryApplyByCom?apply_status=${apply_status}">首页</a>
										...
										<c:if test="${info.pageNum > 1}">
											<a href="${pageContext.request.contextPath}/company/queryApplyByCom?page=${info.pageNum -1}&apply_status=${apply_status}">上一页</a>
										</c:if>
										...
										<c:if test="${info.pageNum < info.pages}">
											<a href="${pageContext.request.contextPath}/company/queryApplyByCom?page=${info.pageNum +1}&apply_status=${apply_status}">下一页</a>
										</c:if>
										<a  href="${pageContext.request.contextPath}/company/queryApplyByCom?page=${info.size}&apply_status=${apply_status}">尾页</a>
										<div class="clear"></div>
									</div>
								</td>
							</tr>
