      ...
      <td valign="top" class="link_lan">
          <div class="com_user_box">
              ...
              <div class="com_user_box" style="margin-top:10px;">
                  <div class="titbox">
                      <div class="lefttit"><u>该公司其他职位</u></div>
                      ...
                      <tr>
                          <td height="50" align="center">
                              <div class="page link_bk">
                                  <a href="${pageContext.request.contextPath}/user/queryPositionsByCompanyId?company_id=${comp.company_id}">首页</a>
                                  ...
                                  <c:if test="${info.pageNum > 1}">
                                      <a href="${pageContext.request.contextPath}/user/queryPositionsByCompanyId?company_id=${comp.company_id}&page=${info.pageNum -1}">上一页</a>
                                  </c:if>
                                  ...
                                  <c:if test="${info.pageNum < info.pages}">
                                      <a href="${pageContext.request.contextPath}/user/queryPositionsByCompanyId?company_id=${comp.company_id}&page=${info.pageNum +1}">下一页</a>
                                  </c:if>
                                  <a  href="${pageContext.request.contextPath}/user/queryPositionsByCompanyId?company_id=${comp.company_id}&page=${info.pages}">尾页</a>
                                  当前是${info.pageNum}页
                                  <div class="clear"></div>
                              </div>
                          </td>
