...
<body>
  ...
  <tr>
	...
	<div class="tip">
			...
			<br />
	学历：${info.degree}	&nbsp;&nbsp;工作经验：${info.work_age}&nbsp;&nbsp;	</div>
    </td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="140" rowspan="6" align="center" bgcolor="#FFFFFF"><img src="${pageContext.request.contextPath}/images/user/1376273539872.jpg" width="120" height="150" /></td>
  </tr>
  <tr>
...
<table  border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#CCCCCC" class="resume_show resume_contact" >
    ...
    <tr>
	  ...
	  <div id="resume_contact">
	  	<ul>
	  		<li>联 系 人：${info.fullname}</li><li>联系电话：${info.phone}</li>
