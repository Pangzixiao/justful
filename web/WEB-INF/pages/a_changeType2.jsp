...
<body style="background-color:#E0F0FE">
	<div class="admin_main_nr_dbox">
		...
		<form  method="post" action="/adm/updateType2" >
			<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top:20px; margin-bottom:20px;" >
				...
				<td  ><input name="p2name"   class="input_text_200"   maxlength="20" value="${type.pname}" /></td>
				</tr>
				<tr>
					...
					<input type="hidden" name="p2" value="${type.p2}"/>
