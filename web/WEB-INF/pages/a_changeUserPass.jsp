...
<body style="background-color:#E0F0FE">
	<div class="admin_main_nr_dbox">
		...
		<form  method="post" action="/adm/changeUserPass" >
			<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top:20px; margin-bottom:20px;" >

				<td width="150" height="30" align="right" bgcolor="#FFFFFF"  ><span style="color:#FF3300; font-weight:bold">*</span>用户名：</td>
				<td  ><input name="username"   class="input_text_200"   maxlength="20" /></td>
				</tr>
				<tr>
					<td height="30" align="right" bgcolor="#FFFFFF" ><span style="color:#FF3300; font-weight:bold">*</span>新密码：</td>
					<td   ><input name="password" type="password" class="input_text_200"  maxlength="18"  /></td>
				</tr>
				<tr>
